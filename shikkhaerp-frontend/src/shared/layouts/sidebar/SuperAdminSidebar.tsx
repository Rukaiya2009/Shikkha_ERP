// src/shared/layouts/sidebar/SuperAdminSidebar.tsx
...
const navItems: NavItem[] = [
  { title: 'Dashboard', path: '/super-admin/dashboard', icon: LayoutDashboard },
  {
    ...
    children: [
      ...
      { title: 'Roles', path: '/super-admin/roles' },
      { title: 'Permissions', path: '/super-admin/permissions' },
    ],
  },
  {
    title: 'Student Management',
    icon: GraduationCap,
    children: [{ title: 'Student List', path: '/super-admin/students' }],
  },
  {
    title: 'Teacher Management',
    icon: Users,
    children: [{ title: 'Teacher List', path: '/super-admin/teachers' }],
  },
  {
    title: 'Settings',
    icon: Settings,
    children: [
      { title: 'School Profile', path: '/super-admin/settings/profile' },
      { title: 'Branding', path: '/super-admin/settings/branding' },
      { title: 'Preferences', path: '/super-admin/settings/preferences' },
    ],
  },
];
